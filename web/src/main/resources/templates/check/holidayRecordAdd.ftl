	...
	new Vue({
		...
		methods:{
			...
			submitForm(){
				...
				this.$data.data.checkComprehensiveHolidayList = this.$data.tableData;
				var notify = false;
	        ...
	        submitListForm(formName){
	        	...
	        	this.$data.data.checkComprehensiveHolidayList[this.$data.listForm.index].checkDangerChecklist = JSON.parse(JSON.stringify(this.$data.listForm));
	        	this.$refs[formName].resetFields();
	        ...
	        submitDangerForm(formName){
	        	...
	        	this.$data.data.checkComprehensiveHolidayList[this.$data.dangerForm.index].checkDangerLedger = JSON.parse(JSON.stringify(this.$data.dangerForm));
		        this.$refs[formName].resetFields();
	        ...
	        submitReceiptForm(formName){
	        	var that = this;
	        	this.$data.dangerLedgerVisible = false;
	        	this.$data.data.checkComprehensiveHolidayList[this.$data.receiptForm.index].checkRectificationReceipt = JSON.parse(JSON.stringify(this.$data.receiptForm));
	        	this.$refs[formName].resetFields();
