...
<html>
	...
	<body>
		<div id="app">
			<el-container>
				<el-header>
					<el-col :span="8">&nbsp;</el-col><el-col :span="8" style="text-align:center;font-size:32px;">隐患排查治理月排查记录列表</el-col><el-col :span="8">&nbsp;</el-col>
				</el-header>
				<el-main>
...
<script type="text/javascript" src="/Public/js/check/monthRecordPage.js" ></script>
