...
import com.welsee.excel.annotation.Textattr;
import com.welsee.excel.event.WriteHandler;
import com.welsee.excel.metadata.BaseRowModel;
import com.welsee.excel.metadata.DropDownHelper;
import com.welsee.excel.metadata.ExcelHeadProperty;
import com.welsee.excel.metadata.Table;
import com.welsee.excel.support.ExcelTypeEnum;
import com.welsee.excel.util.CollectionUtils;
import com.welsee.excel.util.StyleUtil;
import com.welsee.excel.util.WorkBookUtil;
...
public class WriteContext {
     ...
     * current param
     */
    private com.welsee.excel.metadata.Sheet currentSheetParam;
     ...
     * @param sheet
     */
    public void currentSheet(com.welsee.excel.metadata.Sheet sheet) {
    ...
    private void initCurrentSheet(com.welsee.excel.metadata.Sheet sheet) {
    ...
    private void initDropDownSource(com.welsee.excel.metadata.Sheet sheet) {
    ...
    private void addMergedRegionToCurrentSheet(int startRow) {
        for (com.welsee.excel.metadata.CellRange cellRangeModel : excelHeadProperty.getCellRangeModels()) {
    ...
    private void initTableStyle(com.welsee.excel.metadata.TableStyle tableStyle) {
        if (tableStyle != null) {
    ...
    public com.welsee.excel.metadata.Sheet getCurrentSheetParam() {
        return currentSheetParam;
    }

    public void setCurrentSheetParam(com.welsee.excel.metadata.Sheet currentSheetParam) {
