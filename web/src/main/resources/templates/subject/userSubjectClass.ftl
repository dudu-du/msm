    ...
    <div class="welsee-table welsee-table-onlynew layui-col-md12">
        <div class="welsee-table-child">
            <div class="layui-card">
                ...
                <script type="text/html" id="toolbarDemo">
                    <div class="layui-btn-container">
                        <div class="table-btns-box">
                            <button class="layui-btn layui-btn-sm" lay-event="addTeacher">添加任课教师</button>
                            <div class="layui-btn-group layui-hide">
                                <button class="layui-btn layui-btn-primary layui-btn-sm" lay-event="download">下载模板</button>
                                <button class="layui-btn layui-btn-primary layui-btn-sm" lay-event="import"><i class="layui-icon"></i>导入</button>
                                <button class="layui-btn layui-btn-primary layui-btn-sm" lay-event="export"><i class="layui-icon"></i>导出</button>
                            </div>
                        </div>
                        ...
                        <div class="table-btns-right2">
                            <div class="table-search-box clearfix">
                                <input type="text" name="searchVal" placeholder="搜索用户姓名进行查询" value="{{ searchText }}">
                ...
                <script type="text/html" id="classText">
            </script>
            ...
            <div class="layui-card-body layui-form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="section" lay-filter="screenSection">
...
<script src="/Public/js/subject/teachSub.js"></script>
</body>
</html>