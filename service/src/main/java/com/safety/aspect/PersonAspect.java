...
import com.safety.tools.HanyupinyinUtil;
...
public class PersonAspect {
     ...
     * 切入的点
     */
    @Pointcut("execution(public * com.safety.service.impl.PersonServiceImpl.saveEntity(..)) " +
            "||execution(public * com.safety.service.impl.PersonServiceImpl.updateEntityById(..))" +
            "||execution(public * com.safety.service.impl.PersonServiceImpl.saveEntityBatch(..))" +
            "||execution(public * com.safety.service.impl.PersonServiceImpl.removeByIdStr(..))")
