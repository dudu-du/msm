...
<html>
	...
	<body>
		<div id="app">
			<el-container>
				<el-header>
					<el-col :span="8">&nbsp;</el-col><el-col :span="8" style="text-align:center;font-size:32px;">综合检查(节假日、复产前)列表</el-col><el-col :span="8">&nbsp;</el-col>
				</el-header>
				<el-main>
...
<script type="text/javascript" src="/Public/js/check/holidayRecordPage.js" ></script>
