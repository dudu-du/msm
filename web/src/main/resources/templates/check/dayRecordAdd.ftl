	...
	new Vue({
		...
		methods:{
	        ...
	        submitListForm(formName){
	        	...
	        	this.$data.data.checkDayList[this.$data.listForm.index].checkDangerChecklist = JSON.parse(JSON.stringify(this.$data.listForm));
	        	this.$refs[formName].resetFields();
	        ...
	        submitDangerForm(formName){
	        	...
	        	this.$data.data.checkDayList[this.$data.dangerForm.index].checkDangerLedger = JSON.parse(JSON.stringify(this.$data.dangerForm));
		        this.$refs[formName].resetFields();
	        ...
	        submitReceiptForm(formName){
	        	var that = this;
	        	this.$data.dangerLedgerVisible = false;
	        	this.$data.data.checkDayList[this.$data.receiptForm.index].checkRectificationReceipt = JSON.parse(JSON.stringify(this.$data.receiptForm));
	        	this.$refs[formName].resetFields();
