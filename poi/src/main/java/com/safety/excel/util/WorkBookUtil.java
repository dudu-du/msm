package com.safety.excel.util;

import com.safety.excel.ExcelWriter;
import com.safety.excel.context.WriteContext;
import com.safety.excel.support.ExcelTypeEnum;
import com.safety.excel.write.ExcelBuilderImpl;
...
public class WorkBookUtil {
    ...
    public static Sheet createOrGetSheet(Workbook workbook, com.safety.excel.metadata.Sheet sheet) {
        Sheet sheet1 = null;
        try {
            try {
    ...
    public static Sheet createSheet(Workbook workbook, com.safety.excel.metadata.Sheet sheet) {
    ...
    private static Workbook getWorkbook(ExcelWriter writer) {
        ...
        try {
            Class<?> clazz1 = Class.forName("com.safety.excel.ExcelWriter");
            ...
            for (Field field : fs) {
                ...
                if ("excelBuilder".equals(field.getName())) {
                    ...
                    Class<?> clazz2 = Class.forName("com.safety.excel.write.ExcelBuilderImpl");
