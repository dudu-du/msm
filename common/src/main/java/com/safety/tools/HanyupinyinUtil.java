...
public class HanyupinyinUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(hanyuPinyinHelper.getFirstLetters("复兴路小学", HanyuPinyinCaseType.UPPERCASE));
        System.out.println(getFirstLettersUp("复兴路"));
        System.out.println(getFirstLettersLo("复兴路"));
        System.out.println(toHanyuPinyin("复兴路"));
        System.out.println(getFirstLetters("复兴路"));
        System.out.println(getFirstLetter("复兴路"));
