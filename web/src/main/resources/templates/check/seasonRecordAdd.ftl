...
<html>
	...
	<body>
		<div id="app">
			<el-container>
				<el-header>
					<el-col :span="8">&nbsp;</el-col><el-col :span="8" style="text-align:center;font-size:32px;">综合检查(季节性)</el-col><el-col :span="8">&nbsp;</el-col>
				</el-header>
				<el-main>
...
<script type="text/javascript" >
	new Vue({
		...
		methods:{
			...
			submitForm(){
				this.$data.data.checkSeasonList = this.$data.tableData;
				var notify = false;
