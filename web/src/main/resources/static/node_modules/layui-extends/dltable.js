...
//单元格编辑
        ...
        that.layTool.on("click", "*[lay-event]", function () {
            layui.event.call(this,"table", "toolbar(" + filter + ")",{event: _BODY, config: options}, {})
        });
        //同步滚动条
    ...
    //自动完成渲染
    table.init();
    layui.link('/node_modules/layui-extends/treeGrid.css');//引入css
